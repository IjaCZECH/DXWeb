...
namespace DX.Data.Xpo.Identity
{
         ...
         where TClaim : class
    {
        ...
        public virtual bool IsInAlienRole(string roleName, int alienID)
        {
            ...
            return ((List<XpoDxAlienUserRole>)AliensList).Any(x => x.Role.NormalizedName == roleName && x.AlienID == alienID);
        }
